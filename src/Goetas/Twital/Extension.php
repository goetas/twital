...
interface Extension
{
	...
	/**
	 * Array of objects implementing Attribute interface, responsible of DOM attribute handling.
	...
	/**
     * Array of objects implementing {DOMLoader} interface, responsible of DOM loading and dumping.
     * The key of
	 * @return array
	 */
